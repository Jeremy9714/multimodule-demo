...
var Layout = function () {
    ...
    var handleFixedSidebarHoverEffect = function () {
        // 交互逻辑修改，不需要hover交互
        // var body = $('body');
        // if (body.hasClass('page-sidebar-fixed')) { //左侧固定的时候
        //     $('.page-sidebar').on('mouseenter', function () {
        //         if (body.hasClass('page-sidebar-closed')) { //点击收缩了
    ...
    var handleSidebarToggler = function () {
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if($('#frame')[0].contentWindow.onFrameResize){
                $('#frame')[0].contentWindow.onFrameResize();
            }
        });
    };
