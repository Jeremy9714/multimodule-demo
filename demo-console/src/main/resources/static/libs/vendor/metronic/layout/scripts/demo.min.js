    ...
    var e = function () {
            ...
            var a = function () {
                ...
                i = function (e) {
                    ...
                    $("#style_color").attr("href", Layout.getLayoutCssPath() + "themes/" + a + ".min.css"), "light2" == e ? $(".page-logo img").attr("src", getLogoPath() + "logo.png") : $(".page-logo img").attr("src", getLogoPath() + "logo.png")
                };
